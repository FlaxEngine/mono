...
MONO_API MONO_RT_EXTERNAL_ONLY mono_bool mono_gc_reference_queue_foreach_remove(MonoReferenceQueue *queue, mono_reference_queue_remove_check func, void *user_data);
MONO_API MONO_RT_EXTERNAL_ONLY mono_bool mono_gc_reference_queue_foreach_remove2(MonoReferenceQueue *queue, mono_reference_queue_remove2_check func, void *user_data);
